...
# C:\Users\DELL\Desktop\Motor_New\motor_new\uart\uart\uart.mhs
# The software specification of the system is in file :
# C:\Users\DELL\Desktop\Motor_New\motor_new\uart\uart\uart.mss

include uart_incl.make
...
uart_program: $(UART_OUTPUT) 

$(UART_OUTPUT) : $(UART_SOURCES) $(UART_HEADERS) $(UART_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/uart_compiler.opt
	@mkdir -p $(UART_OUTPUT_DIR) 
	$(UART_CC) $(UART_CC_OPT) $(UART_SOURCES) -o $(UART_OUTPUT) \
	$(UART_OTHER_CC_FLAGS) $(UART_INCLUDES) $(UART_LIBPATH) \
	$(UART_CFLAGS) $(UART_LFLAGS) 
	$(UART_CC_SIZE) $(UART_OUTPUT) 
	@echo ""
...
$(SYSTEM_ACE): $(DOWNLOAD_BIT) $(UART_OUTPUT) 
	@echo "*********************************************"
	@echo "Creating system ace file"
	@echo "*********************************************"
	xmd -tcl genace.tcl -jprog -hw $(DOWNLOAD_BIT) -elf $(UART_OUTPUT)  -target ppc_hw  -ace $(SYSTEM_ACE)
